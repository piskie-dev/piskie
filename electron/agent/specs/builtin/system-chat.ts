...
export const systemChatSpec: AgentSpec = {
  ...
  tools: {
    sdkGroups: [],
    customTools: ['web_search', ...WORKSPACE_TOOL_NAMES, 'subagent', 'subagent_stop', 'send_event', 'plan', 'task', 'ask_user', 'generate_image', 'agent_run', 'schedule', 'schedule_list', 'schedule_cancel', 'load_skill', 'skill_call'],
  },
