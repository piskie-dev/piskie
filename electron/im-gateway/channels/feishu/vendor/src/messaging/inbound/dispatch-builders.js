 ...
 *
 * Note (PISKIE 本地改动，49号 §4.3.5): media placeholders are STRIPPED from
 * `ctx.content` upstream (handler.ts -> substituteMediaPaths)——本地路径不
 * 进正文；图片经 MediaPaths 由核心层转换为 ExternalEvent.images。
 */
